    ...
    <>
      ...
      >
        ...
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I am passionate about <span className="heroShiny1 text-fun-pink">automating tasks</span> to{" "}
          make humans <span className="heroShiny2 text-fun-pink">go fast.</span>
          <img
